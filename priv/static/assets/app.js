(() => {
  ...
  var require_topbar = __commonJS({
    "vendor/topbar.js"() {
      !function(e) {
        function t() {
          return e.pageYOffset || e.document.documentElement.scrollTop;
        }
        function n() {
          return e.document.body.scrollHeight || e.document.documentElement.scrollHeight;
        }
        function o() {
          var e2 = parseInt((n() - t()) / 2);
          return 0 === e2 ? 1 : e2;
        }
        function i() {
          f || (f = true, r());
        ...
        function r() {
          var e2 = o();
          m.animate({ width: "+=100%" }, e2, function() {
            setTimeout(function() {
              m.animate({ width: 100 * (s - u) / s + "%" }, e2, function() {
                m.width(100), r();
              });
            }, p);
          });
        ...
        function c() {
          f && (m.stop().width(0), clearTimeout(l), f = false);
        }
        function a() {
          e.addEventListener ? (document.addEventListener("scroll", d, false), window.addEventListener("resize", d, false)) : e.attachEvent("onscroll", d);
        }
        function d() {
          f && u < n() ? (m.stop().width("100%"), clearTimeout(l)) : !f && s < n() && (l = setTimeout(i, p));
        }
        var u = t(), s = n(), m = null, l = null, f = false, p = 300, h = null;
        e.topbar = function(e2) {
          "function" == typeof e2 && (h = e2);
        }, e.topbar.config = function(e2) {
          p = e2.delay || p, e2.barColors && topbar.config({ barColors: e2.barColors });
        }, e.topbar.show = function() {
          m || function() {
            m = document.createElement("div"), m.id = "topbar", m.style.cssText = "position:fixed;top:0;left:0;height:2px;background:#29d;z-index:2000;transition:height .1s linear 0s;", m.height = 0, document.body.appendChild(m);
          }(), a(), i();
        }, e.topbar.hide = function() {
          c(), h && (m.height = 0, m.addEventListener("transitionend", function e2() {
            m && (document.body.removeChild(m), m = null), h(), m.removeEventListener("transitionend", e2, false);
          }));
        }, e.topbar.progress = function(e2) {
          e2 && m.stop().width(e2 + "%");
        };
      }(window);
    }
...
`);
  ...
  var LocalTime = class extends HTMLElement {
    connectedCallback() {
      const dt = /* @__PURE__ */ new Date(this.getAttribute("datetime") + "Z");
